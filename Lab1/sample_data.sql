...
('CS', 'Computer Science', 'CS', '111-111-1111', 'Engineering'),
('MATH', 'Mathematics', 'MATH', '222-222-2222', 'Mathematics'),
('CSF', 'Cyber Security', 'CSF', '333-333-3333', 'Engineering');
...
(1001, '123456789', 'Jatin', 'Singh', 'Plot 180 P&B Society', 'Dehradun', 'UK', '248007', '111-111-0000',
'Plot 180, P&B Society', 'Dehradun', 'UK', '248007', '111-111-0000', '2000-01-01', 'M', 'Freshman', 'MTECH', 'CSF', 'MATH'),
(1002, '987654321', 'Rahul', 'Verma', 'Plot 180, P&B Society', 'Dehradun', 'UK', '248007', '222-222-0000',
'Plot 180, P&B Society', 'Dehradun', 'UK', '248007', '222-222-0000', '2001-01-01', 'M', 'Freshman', 'MTECH', 'CS', NULL),
(1003, '555667777', 'Rupesh', 'Dagar', 'Plot 181 P&B Society', 'Dehradun', 'UK', '248007', '333-333-0000',
...
('CS101', 'Intro to Programming', 'Basics of programming in Python', 30, 'Postgraduate', 'CS'),
('CSF201', 'Network Security', 'Principles of cybersecurity and networking', 35, 'Postgraduate', 'CSF'),
('MATH301', 'Linear Algebra', 'Matrix theory and linear algebra', 40, 'Undergraduate', 'MATH');

-- Insert Sections
INSERT INTO Section (CourseNumber, Semester, Year, SectionNumber, InstructorID) VALUES
('CS101', 'Summer', 2025, 1, 2),   -- Raghav teaches CS
('CSF201', 'Summer', 2025, 1, 1),  -- Jigesh teaches CSF
('MATH301', 'Summer', 2025, 1, 3); -- William teaches Math

-- Insert Grade Reports
INSERT INTO GradeReport (StudentNumber, SectionID, LetterGrade, NumericGrade) VALUES
(1001, 2, 'A', 4),  -- Jatin (student) in Cyber Security
(1002, 1, 'B', 3),  -- Rahul (student) in CS
(1003, 3, 'A', 4);  -- Rupesh (student) in Math
